    ...
    <div className="relative min-h-screen">
      ...
      {/* Skills & Interests */}
            ...
            <motion.div
              ...
              <p><span className="font-medium">Frameworks/Tools:</span> React, Next.js, Node.js, Express, Tailwind, MySQL, PostgreSQL, MongoDB, Git, scikit-learn, Pandas, Firebase, Cloudinary</p>
